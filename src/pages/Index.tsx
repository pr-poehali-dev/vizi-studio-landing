    ...
    <div style={{ background: "var(--color-bg)", color: "var(--color-text)" }}>
      ...
      <header className="vz-header" ref={headerRef}>
        ...
        <div className={`vz-container vz-mobile-panel${menuOpen ? " open" : ""}`}>
          {[["#problems","Проблемы"],["#solution","Решение"],["#offers","Пакеты"],["#cases","Кейсы"],["#faq","FAQ"],["#cta","Получить разбор"]].map(([href,label]) =>
        ...
        <section className="vz-hero" id="hero">
          <div className="vz-container vz-hero-grid">
            <div className="hero-copy reveal" data-delay="1">
              ...
              <h1>Собираем систему роста для бизнеса, который хочет получать больше заявок и выглядеть сильнее.</h1>
              <p className="vz-hero-lead">VIZI Studio соединяет стратегию, сайт, контент и автоматизацию в одну понятную систему. Чтобы ваш бизнес быстрее вызывал доверие, не терял входящие и продавал без хаоса в коммуникациях.</p>
          ...
          <div className="vz-container">
            ...
            <div className="vz-grid-2">
              {[
                ...
                { l:"VIZI Beauty", h:"Запись, напоминания и возврат клиентов", p:"Для барбершопов, салонов, косметологии, стоматологии и частных клиник. Запись, напоминания, реактивация базы, автоответы и мини-страница под запись.", pills:["Результат: больше записей","Запуск: 10 дней","от 45 000 ₽"] },
                { l:"VIZI Sales", h:"Автоответы и квалификация заявок", p:"Для недвижимости, стройки, логистики, сложных услуг и B2B. Автоответы, квалификация входящих, уведомления, сценарии прогрева и контроль потерянных обращений.", pills:["Результат: тёплые лиды","Запуск: 14 дней","от 60 000 ₽"] },
        ...
        <section className="vz-section">
          <div className="vz-container">
            <div className="vz-section-head reveal">
              ...
              <p>Пользователь должен быстро понимать маршрут: что будет после нажатия кнопки и насколько это сложно.</p>
            </div>
            <div className="vz-grid-3">
              {[
